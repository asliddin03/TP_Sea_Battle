...
class draw:
    def ship(ships_coor_list):
        for i in ships_coor_list:
            ...
            pygame.draw.rect(glob_var.screen, glob_var.BL, ((
                x, y), (ship_w, ship_h)), width=glob_var.block_sz//10)
    ...
    def grid():
        ...
        for i in range(11):
            ...
            for j in list:
                pygame.draw.line(glob_var.screen, glob_var.BL, (glob_var.l_margin +
                                 j[0], glob_var.upp_margin + j[1]), (glob_var.l_margin + j[2], glob_var.upp_margin + j[3]), 2)
            if i < 10:
                ...
                list1 = [[num_ver, -glob_var.block_sz1 - num_ver_width1, i * glob_var.block_sz + glob_var.block_sz1 - num_ver_height1], [let_hor, i * glob_var.block_sz + glob_var.block_sz1 - let_hor_width1, 10 * glob_var.block_sz + 5],
                         [num_ver, -glob_var.block_sz1 - num_ver_width1 + 15 * glob_var.block_sz,
                             i * glob_var.block_sz + glob_var.block_sz1 - num_ver_height1],
                         [let_hor, (i + 15) * glob_var.block_sz + glob_var.block_sz1 - let_hor_width1, 10 * glob_var.block_sz + 5]]
                for j in list1:
                    glob_var.screen.blit(
                        j[0], (glob_var.l_margin + j[1], glob_var.upp_margin + j[2]))
