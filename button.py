...
class button:
    ...
    def __init__(self, x_ofs, button1):
        ...
        self.__y = global_variable.upp_margin + 4 * global_variable.block_sz + self.__button_h
        self.draw = self.__x, self.__y - 20, self.__button_w - 40, self.__button_h
        self.rect = pygame.Rect(self.draw)
        self.__button_tl = self.__x + self.__button_w // 2 - self.__tl_w // 2 - 20, self.__y + self.__button_h // 2 - self.__tl_h // 2 - 20
    ...
    def Draw(self, cl = None):
        ...
        text = global_variable.font.render(self.__tl, True, global_variable.L_GRAY)
